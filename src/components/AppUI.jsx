...
const AppUI = () => {
  return (
    <section className="p-20 flex flex-col md:flex-row justify-center items-center bg-blue-900">
      <div className="md:w-1/2 p-10 text-center">
        <h2 className="text-5xl font-bold text-gray-200 mb-6">
          The <span className="text-blue-400">conci</span> app is designed with thriving families in mind:
        </h2>
