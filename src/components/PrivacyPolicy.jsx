...
const PrivacyPolicy = () => {
  return (
    <div className="bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 sm:p-12">
        <h1 className="text-4xl font-bold text-blue-600 dark:text-blue-400 mb-4 pb-4 border-b-4 border-blue-600">
          PRIVACY POLICY FOR CONCI
        </h1>

        <p className="text-gray-600 dark:text-gray-400 text-sm mb-8 italic">
          <strong>Last Updated:</strong> October 21, 2025<br />
          <strong>Effective Date:</strong> October 17, 2025
        </p>

        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-blue-600 dark:text-blue-400 mb-4 pb-2 border-l-4 border-blue-600 pl-4">
            1. INTRODUCTION
          </h2>
        ...
        <section className="mb-8">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-3 mt-6">
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">A. Firebase (Google Cloud Platform)</p>
            <ul className="list-disc ml-8 mb-4 text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://firebase.google.com/support/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline break-all">firebase.google.com/support/privacy</a></li>
            </ul>
          </div>

          <div className="mb-6">
            <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">B. Razorpay</p>
            <ul className="list-disc ml-8 mb-4 text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://razorpay.com/privacy/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline break-all">razorpay.com/privacy/</a></li>
              <li><strong>Note:</strong> Razorpay is PCI-DSS compliant for secure payment handling</li>
            </ul>
          </div>

          <div className="mb-6">
            <p className="font-semibold text-gray-800 dark:text-gray-200 mb-2">C. Google Maps Platform</p>
            <ul className="list-disc ml-8 mb-4 text-gray-700 dark:text-gray-300 space-y-2">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline break-all">policies.google.com/privacy</a></li>
            </ul>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 p-4 my-6 rounded">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-8 mb-4 text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <li><strong>Deletion URL:</strong> <a href="#cancel-membership" className="text-blue-600 dark:text-blue-400 hover:underline">Account Deletion Information</a></li>
        ...
        <section className="mb-8 bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2">
            <strong>Email:</strong> <a href="mailto:help@conci.in" className="text-blue-600 dark:text-blue-400 hover:underline">help@conci.in</a><br />
            <strong>Privacy Matters:</strong> <a href="mailto:help@conci.in" className="text-blue-600 dark:text-blue-400 hover:underline">help@conci.in</a><br />
            <strong>Website:</strong> <a href="https://conci.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">conci.in</a>
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-2"><strong>You consent to:</strong></p>
          <ul className="list-disc ml-8 mb-4 text-gray-700 dark:text-gray-300 space-y-2">
        ...
        <div className="text-center border-t-2 border-gray-300 dark:border-gray-600 pt-6 mt-8">
