...
export const Card = ({ title, description, iconName, currentTheme }) => {
  const Icon = iconMap[iconName];
  
  // This is the corrected conditional class logic
  const iconColorClass = currentTheme === 'dark' ? 'filter invert' : 'filter invert-0';
